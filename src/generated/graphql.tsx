...
export type FetchRocketsQueryVariables = Exact<{ [key: string]: never; }>;


export type FetchRocketsQuery = { __typename?: 'Query', rockets?: Array<{ __typename?: 'Rocket', id?: string | null, name?: string | null } | null> | null };


export const FetchRocketsDocument = gql`
    query fetchRockets {
  rockets {
    id
    name
...
/**
 * __useFetchRocketsQuery__
 *
 * To run a query within a React component, call `useFetchRocketsQuery` and pass it any options that fit your needs.
 * When your component renders, `useFetchRocketsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFetchRocketsQuery({
 *   variables: {
 *   },
 * });
 */
export function useFetchRocketsQuery(baseOptions?: Apollo.QueryHookOptions<FetchRocketsQuery, FetchRocketsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FetchRocketsQuery, FetchRocketsQueryVariables>(FetchRocketsDocument, options);
      }
export function useFetchRocketsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FetchRocketsQuery, FetchRocketsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FetchRocketsQuery, FetchRocketsQueryVariables>(FetchRocketsDocument, options);
        }
export type FetchRocketsQueryHookResult = ReturnType<typeof useFetchRocketsQuery>;
export type FetchRocketsLazyQueryHookResult = ReturnType<typeof useFetchRocketsLazyQuery>;
export type FetchRocketsQueryResult = Apollo.QueryResult<FetchRocketsQuery, FetchRocketsQueryVariables>;